...
hard_coded_window_keys pan_view_window_keys[] = {
	...
	{NO_GDK_MODIFIER, GDK_KEY_Escape, N_("Exit fullscreen")},
	{NO_GDK_MODIFIER, GDK_KEY_Escape, N_("Hide Find search bar")},
	{NO_GDK_MODIFIER, GDK_KEY_equal, N_("Zoom in")},
	{NO_GDK_MODIFIER, GDK_KEY_plus, N_("Zoom in")},
	{NO_GDK_MODIFIER, GDK_KEY_minus, N_("Zoom out")},
	{NO_GDK_MODIFIER, GDK_KEY_Z, N_("Zoom 1:1")},
	{NO_GDK_MODIFIER, GDK_KEY_1, N_("Zoom 1:1")},
	{NO_GDK_MODIFIER, GDK_KEY_KP_Divide, N_("Zoom 1:1")},
	{NO_GDK_MODIFIER, '2', N_("Zoom 2:1")},
	{NO_GDK_MODIFIER, '3', N_("Zoom 3:1")},
	{NO_GDK_MODIFIER, '4', N_("Zoom 4:1")},
	{NO_GDK_MODIFIER, '7', N_("Zoom 1:4")},
	{NO_GDK_MODIFIER, '8', N_("Zoom 1:3")},
	{NO_GDK_MODIFIER, '9', N_("Zoom 1:2")},
	{NO_GDK_MODIFIER, 'F', N_("Full screen")},
	{NO_GDK_MODIFIER, 'V', N_("Full screen")},
	{NO_GDK_MODIFIER, GDK_KEY_F11, N_("Full screen")},
	{NO_GDK_MODIFIER, '/', N_("Display Find search bar")},
	{NO_GDK_MODIFIER, GDK_KEY_Left, N_("Scroll left")},
	{NO_GDK_MODIFIER, GDK_KEY_Right, N_("Scroll right")},
	{NO_GDK_MODIFIER, GDK_KEY_Up, N_("Scroll up")},
	{NO_GDK_MODIFIER, GDK_KEY_Down, N_("Scroll down")},
	...
	{NO_GDK_MODIFIER, GDK_KEY_Page_Up, N_("Scroll display half screen up")},
	{NO_GDK_MODIFIER, GDK_KEY_Page_Down, N_("Scroll display half screen down")},
	{NO_GDK_MODIFIER, GDK_KEY_Home, N_("Scroll display half screen left")},
	{NO_GDK_MODIFIER, GDK_KEY_End, N_("Scroll display half screen right")},
...
{
	PanCacheData *pca = (PanCacheData *)a;
	PanCacheData *pcb = (PanCacheData *)b;
...
static void pan_cache_step_done_cb(CacheLoader *cl, gint UNUSED(error), gpointer data)
{
	...
	if (pw->cache_list)
		{
		PanCacheData *pc;
		pc = (PanCacheData *)pw->cache_list->data;
...
static gboolean pan_cache_step(PanWindow *pw)
{
	...
	fd = (FileData *)pw->cache_todo->data;
	...
	if (pw->size > PAN_IMAGE_SIZE_THUMB_LARGE) load_mask = (CacheDataType)(load_mask | CACHE_LOADER_DIMENSIONS);
	if (pw->exif_date_enable) load_mask = (CacheDataType)(load_mask | CACHE_LOADER_DATE);
...
static void pan_info_add_exif(PanTextAlignment *ta, FileData *fd)
{
	...
	while (exif_list)
		{
		title = (gchar *)exif_list->data;
		exif_list = exif_list->next;
		key = (gchar *)exif_list->data;
		exif_list = exif_list->next;
...
static void pan_window_layout_change_cb(GtkWidget *combo, gpointer data)
{
	...
	pw->layout = (PanLayoutType)gtk_combo_box_get_active(GTK_COMBO_BOX(combo));
	pan_layout_update(pw);
}
...
static void pan_window_layout_size_cb(GtkWidget *combo, gpointer data)
{
	...
	pw->size = (PanImageSize)gtk_combo_box_get_active(GTK_COMBO_BOX(combo));
	pan_layout_update(pw);
}
...
static void pan_window_new_real(FileData *dir_fd)
{
	...
	gtk_table_attach(GTK_TABLE(table), pw->scrollbar_v, 1, 2, 0, 1,
			 (GtkAttachOptions)0, (GtkAttachOptions)(GTK_FILL | GTK_EXPAND), 0, 0);
...
static void pan_edit_cb(GtkWidget *widget, gpointer data)
{
	...
	pw = (PanWindow *)submenu_item_get_data(widget);
	if (!pw) return;
