...
hard_coded_window_keys image_window_keys[] = {
	...
	{NO_GDK_MODIFIER, GDK_KEY_Delete, N_("Move to Trash")},
	...
	{NO_GDK_MODIFIER, ']', N_(" Rotate counterclockwise 90°")},
	{NO_GDK_MODIFIER, '[', N_(" Rotate clockwise 90°")},
	{NO_GDK_MODIFIER, GDK_KEY_Page_Up, N_("Previous")},
	{NO_GDK_MODIFIER, GDK_KEY_KP_Page_Up, N_("Previous")},
	{NO_GDK_MODIFIER, GDK_KEY_BackSpace, N_("Previous")},
	{NO_GDK_MODIFIER, 'B', N_("Previous")},
	{NO_GDK_MODIFIER, GDK_KEY_Page_Down, N_("Next")},
	{NO_GDK_MODIFIER, GDK_KEY_KP_Page_Down, N_("Next")},
	{NO_GDK_MODIFIER, GDK_KEY_space, N_("Next")},
	{NO_GDK_MODIFIER, 'N', N_("Next")},
	{NO_GDK_MODIFIER, GDK_KEY_equal, N_("Zoom in")},
	{NO_GDK_MODIFIER, GDK_KEY_plus, N_("Zoom in")},
	{NO_GDK_MODIFIER, GDK_KEY_minus, N_("Zoom out")},
	{NO_GDK_MODIFIER, 'X', N_("Zoom to fit")},
	{NO_GDK_MODIFIER, GDK_KEY_KP_Multiply, N_("Zoom to fit")},
	{NO_GDK_MODIFIER, 'Z', N_("Zoom 1:1")},
	...
	{NO_GDK_MODIFIER, 'W', N_("Zoom fit window width")},
	{NO_GDK_MODIFIER, 'H', N_("Zoom fit window height")},
	{NO_GDK_MODIFIER, 'S', N_("Toggle slideshow")},
	{NO_GDK_MODIFIER, 'P', N_("Pause slideshow")},
	{NO_GDK_MODIFIER, 'R', N_("Reload image")},
	{NO_GDK_MODIFIER, 'F', N_("Full screen")},
	{NO_GDK_MODIFIER, 'V', N_("Fullscreen")},
	{NO_GDK_MODIFIER, GDK_KEY_F11, N_("Fullscreen")},
	{NO_GDK_MODIFIER, 'I', N_("Image overlay")},
	{NO_GDK_MODIFIER, GDK_KEY_Escape, N_("Exit fullscreen")},
	{NO_GDK_MODIFIER, GDK_KEY_Escape, N_("Close window")},
